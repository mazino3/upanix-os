...
#define MEM_KERNEL_HEAP_START 0x2000000 // 16 MB + MEM_GRAPHICS_VIDEO_MAP_SIZE
#define MEM_KERNEL_HEAP_SIZE 0x3000000 // 48 MB
#define MEM_KERNEL_PAGE_POOL_SIZE 0x1000000 // 16 MB
#define MEM_KERNEL_RESV_SIZE 0x6000000 // MEM_KERNEL_HEAP_START + MEM_KERNEL_HEAP_START + MEM_KERNEL_PAGE_POOL_SIZE
