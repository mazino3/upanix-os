...
#define MEM_KERNEL_HEAP_START 0x3000000 // 16 MB + MEM_GRAPHICS_VIDEO_MAP_SIZE + MEM_GRAPHICS_Z_BUFFER_SIZE
#define MEM_KERNEL_HEAP_SIZE 0x3000000 // 48 MB
#define MEM_KERNEL_PAGE_POOL_SIZE 0x1000000 // 16 MB
#define MEM_KERNEL_RESV_SIZE 0x7000000 // MEM_KERNEL_HEAP_START + MEM_KERNEL_HEAP_SIZE + MEM_KERNEL_PAGE_POOL_SIZE
...
#define MEM_GRAPHICS_VIDEO_MAP_START 0x1000000 // 16 MB
#define MEM_GRAPHICS_Z_BUFFER_START	0x2000000 // 32 MB
