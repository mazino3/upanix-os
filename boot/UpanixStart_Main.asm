...
_start:
	...
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	MOV ESI, EBX
	MOV EDI, UPANIX_KERNEL_BASE_ADDRESS + MULTIBOOT_INFO_ADDR
	MOV ECX, MULTIBOOT_INFO_LEN
	CLD
	REP MOVSB
...
FRAMEBUFFER_RED_FIELD_POSITION   DB 0
FRAMEBUFFER_RED_MASK_SIZE        DB 0
FRAMEBUFFER_GREEN_FIELD_POSITION DB 0
FRAMEBUFFER_GREEN_MASK_SIZE      DB 0
FRAMEBUFFER_BLUE_FIELD_POSITION  DB 0
FRAMEBUFFER_BLUE_MASK_SIZE       DB 0

MULTIBOOT_INFO_END:

MULTIBOOT_INFO_LEN EQU (MULTIBOOT_INFO_END - MULTIBOOT_INFO_ADDR)
