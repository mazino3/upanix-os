...
extern "C" int vfscanf (FILE *__restrict fp, const Wchar *__restrict format, va_list arg) ;

extern "C" ssize_t __getdelim(char **__restrict lineptr, size_t *__restrict n,
				   int delimiter, register FILE *__restrict stream) ;

extern "C" int __fputs_unlocked(const char *__restrict s, FILE *__restrict stream);

extern "C" int __putchar_unlocked(int c);


extern "C" size_t __fwrite_unlocked(const void *__restrict ptr, size_t size,
								size_t nmemb, FILE *__restrict stream);

extern "C" size_t __fread_unlocked(void *__restrict ptr, size_t size,
							   size_t nmemb, FILE *__restrict stream);

extern "C" int __fputc_unlocked(int c, FILE *stream);

extern "C" int __fflush_unlocked(FILE *stream);

extern int __stdio_adjust_position(FILE *__restrict stream, __offmax_t *pos);

extern "C" void __clearerr_unlocked(FILE *stream);
extern "C" int __feof_unlocked(FILE *stream);
extern int __ferror_unlocked(FILE *stream);

extern "C" int __fgetc_unlocked(FILE *stream);
extern "C" char *__fgets_unlocked(char *__restrict s, int n,
							  FILE * __restrict stream);

extern "C" int __fileno_unlocked(FILE *stream);

extern "C" int __getchar_unlocked(void);
